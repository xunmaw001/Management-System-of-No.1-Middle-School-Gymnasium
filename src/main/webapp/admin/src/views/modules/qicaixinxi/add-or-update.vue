<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所属场地" prop="suoshuchangdi">
          <el-input v-model="ruleForm.suoshuchangdi" 
              placeholder="所属场地" clearable  :readonly="ro.suoshuchangdi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所属场地" prop="suoshuchangdi">
              <el-input v-model="ruleForm.suoshuchangdi" 
                placeholder="所属场地" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yongtu = true;
          ...
          if(o=='suoshuchangdi'){
            this.ruleForm.suoshuchangdi = obj[o];
	    this.ro.suoshuchangdi = true;
            continue;
          }
          if(o=='beizhu'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/qicaileixing/leixing`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
