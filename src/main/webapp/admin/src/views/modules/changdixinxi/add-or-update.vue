    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="场地类型" prop="changdileixing">
          <el-select v-model="ruleForm.changdileixing" placeholder="请选择场地类型">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="场地位置" prop="changdiweizhi">
          <el-input v-model="ruleForm.changdiweizhi" 
              placeholder="场地位置" clearable  :readonly="ro.changdiweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="场地位置" prop="changdiweizhi">
              <el-input v-model="ruleForm.changdiweizhi" 
                placeholder="场地位置" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="维修记录" prop="weixiujilu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.weixiujilu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.weixiujilu" label="维修记录" prop="weixiujilu">
                    <span v-html="ruleForm.weixiujilu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/changdileixing/leixing`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
	...
	this.ruleForm.weixiujilu = this.ruleForm.weixiujilu.replace(reg,'../../../ssmdyn9h/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
